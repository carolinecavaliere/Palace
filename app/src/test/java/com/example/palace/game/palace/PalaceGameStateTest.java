...
public class PalaceGameStateTest {
    ...
    public void getDrawPileNumCards() {
        ...
        int total = (52*2) - (state.getP1numCards() + state.getP2numCards() + state.getP3numCards()
                ...
                + state.getP2TopPalaceCards().size() + state.getP3TopPalaceCards().size()
                + state.getP4TopPalaceCards().size() + state.getP1BottomPalaceCards().size()
                + state.getP2BottomPalaceCards().size() + state.getP3BottomPalaceCards().size()
